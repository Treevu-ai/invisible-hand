...
export const translations = {
  en: {
    ...
    pricing: {
      ...
      headline2: "Pay when it proves its value.",
      monthly: "Monthly", annual: "Annual (2 months free)", save: "", freeLabel: "No card required for Free. Cancel anytime.",
      tiers: [
        { name: "Free", price: "$0", priceAnnual: "$0", desc: "For testing the waters. See what the agent finds.", features: ["5 searches/month", "All 26 retailers", "Basic price comparison", "Email support"], cta: "Start free", highlight: false },
        { name: "Pro", price: "$29", priceAnnual: "$23/mo", desc: "For businesses that buy regularly.", features: ["30 searches/month", "All 26 retailers", "Automated POs", "Supplier comparison", "Priority email support"], cta: "Get Pro", highlight: true },
        { name: "Business", price: "$79", priceAnnual: "$63/mo", desc: "For teams where procurement is strategic.", features: ["100 searches/month", "All 26 retailers", "Everything in Pro", "Spend analytics", "Slack support", "Multi-user"], cta: "Get Business", highlight: false },
      ],
      latamNote: "LATAM-native. Spanish and Portuguese. Invoice in PEN, MXN, BRL, COP. 40% off first year for regional teams.",
...
for opt in result:
  ...
  es: {
    ...
    pricing: {
      ...
      headline: "Gratis para empezar.",
      headline2: "Pagas cuando demuestre su valor.",
      monthly: "Mensual", annual: "Anual (2 meses gratis)", save: "", freeLabel: "Sin tarjeta para el plan Free. Cancela cuando quieras.",
      tiers: [
        { name: "Gratis", price: "$0", priceAnnual: "$0", desc: "Para probar. Mira lo que el agente encuentra.", features: ["5 búsquedas/mes", "26 retailers", "Comparación básica de precios", "Soporte email"], cta: "Empezar gratis", highlight: false },
        { name: "Pro", price: "$29", priceAnnual: "$23/mes", desc: "Para empresas que compran regularmente.", features: ["30 búsquedas/mes", "26 retailers", "POs automatizadas", "Comparación de proveedores", "Soporte prioritario email"], cta: "Obtener Pro", highlight: true },
        { name: "Business", price: "$79", priceAnnual: "$63/mes", desc: "Para equipos donde compras es estratégico.", features: ["100 búsquedas/mes", "26 retailers", "Todo lo de Pro", "Analítica de gasto", "Soporte Slack", "Multi-usuario"], cta: "Obtener Business", highlight: false },
      ],
      latamNote: "Nativo LATAM. Español y portugués. Factura en PEN, MXN, BRL, COP. 40% off primer año para equipos regionales.",
